...
default[:stunnel][:certificate_path] = "/etc/stunnel/stunnel.pem"
default[:stunnel][:key_path]         = "/etc/stunnel/stunnel.pem"
default[:stunnel][:ca_file]          = nil # "/etc/stunnel/cacerts.pem"

default[:stunnel][:services] = {}
default[:stunnel][:certificates] = {}
